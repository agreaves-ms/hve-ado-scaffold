...
tools: ['search', 'editFiles', 'fileSearch', 'codebase', 'think']
---
...
```json
{
	...
	"generated_at": "ISO8601 timestamp",
	"analysis_objectives": [
		{ "type": "exploration|forecasting|classification|regression|clustering|anomaly|dashboard|other", "description": "string" }
	],
